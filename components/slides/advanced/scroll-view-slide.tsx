...
export default function ScrollViewSlide() {
  ...
  const generateLoremIpsum = (paragraphs: number) => {
    const lorem = [
      "스크롤뷰는 화면 크기보다 많은 콘텐츠를 표시하기 위해 필수적인 UI 컴포넌트입니다. 사용자가 콘텐츠를 스크롤하여 탐색하게 합니다.",
      "대부분의 모바일 앱과 웹사이트에서는 스크롤뷰를 기본적으로 사용합니다. 특히 긴 목록이나 피드를 보는 경우에는 더욱 중요합니다.",
      "스크롤뷰에는 세로 스크롤과 가로 스크롤이 있으며, 필요에 따라 두 방향 모두 지원할 수 있습니다.",
      "스크롤뷰의 구현에는 성능 최적화가 중요합니다. 특히 많은 아이템을 표시할 때 가상화(virtualization) 기법을 사용하면 좋습니다.",
...
const App: React.FC = () => {
  ...
  const generateContent = () => {
    const paragraphs = [
      "스크롤뷰는 화면 크기보다 많은 콘텐츠를 표시하기 위해 필수적인 UI 컴포넌트입니다.",
      "대부분의 모바일 앱과 웹사이트에서는 스크롤뷰를 기본적으로 사용합니다.",
      "스크롤뷰에는 세로 스크롤과 가로 스크롤이 있으며, 필요에 따라 두 방향 모두 지원할 수 있습니다.",
      "스크롤뷰의 구현에는 성능 최적화가 중요합니다.",
    ...
    return Array.from({ length: 20 }, (_, i) => (
      ...
      >
        ...
        <div className="text-xs text-gray-400 mt-2">문단 #{i + 1}</div>
      </div>
    ));
  };
...
export default App;`;
  ...
  return (
    <SlideLayout title="Scroll View (스크롤뷰)">
        ...
        <Tabs defaultValue="description">
          ...
          <TabsContent value="description" className="space-y-8 mt-4">
            <div className="prose max-w-none">
              ...
              <p>
                스크롤뷰는 화면에 표시 가능한 영역보다 많은 콘텐츠를 담을 수 있는
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-4 bg-slate-50 rounded-md">
                <h3 className="text-lg font-medium mb-2">스크롤뷰 종류</h3>
              ...
              <div className="p-4 bg-slate-50 rounded-md">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>스크롤바 디자인과 가시성</li>
                  <li>스크롤 성능 최적화(특히 많은 아이템을 표시할 때)</li>
          ...
          <TabsContent value="demo" className="mt-4">
            <div className="flex-1 flex flex-col">
              <div className="flex justify-between items-center mb-3">
                <h3 className="text-lg font-medium">스크롤뷰 표시</h3>
