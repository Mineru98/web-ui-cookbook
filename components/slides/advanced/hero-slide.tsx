...
const ${heroType === "basic" 
  ...
  return (
    ${heroType === "basic" ? `<div className="h-96 bg-gray-200 flex items-center relative overflow-hidden">
      {/* 배경 이미지 영역 */}
      <div className="absolute inset-0">
        <div className="w-full h-full bg-gray-300 flex items-center justify-center">
      ...
      <div className="relative z-20 text-white p-6 max-w-lg">
        ...
        <button 
          ...
          className="bg-white text-[#268052] px-6 py-3 rounded-md font-medium text-sm hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#268052]"
        >
          자세히 보기
        </button>
      </div>
    </div>`
    : heroType === "centered" ? `<div className="h-96 bg-gradient-to-r from-[#268052] to-[#134429] flex items-center justify-center">
      <div className="text-center text-white p-6 max-w-lg mx-auto">
    ...
    : heroType === "split" ? `<div className="h-96 bg-white flex flex-col md:flex-row">
      {/* 왼쪽 텍스트 영역 */}
      <div className="flex-1 bg-[#268052] flex items-center justify-center p-8">
        <div className="text-white max-w-sm">
          ...
          <button 
            ...
            className="text-white border border-white px-4 py-2 rounded-md font-medium text-sm flex items-center gap-2 hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#268052]"
          >
            더 보기
    ...
    : `<div className="h-96 bg-gray-800 flex items-center justify-center overflow-hidden relative">
      ...
      <div className="relative z-20 text-white text-center max-w-lg mx-auto p-6">
        ...
        <button 
          ...
          className="bg-[#268052] text-white px-6 py-3 rounded-md font-medium text-sm hover:bg-[#268052]/90 transition-colors focus:outline-none focus:ring-2 focus:ring-[#268052] focus:ring-offset-2"
        >
          시작하기
        </button>
      </div>
