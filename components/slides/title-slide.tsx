  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-mesh-brand">
      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center px-6 py-12 sm:px-10">
        <div className="reveal-fade mb-6 inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/15 px-4 py-1.5 text-xs font-medium tracking-wide text-white backdrop-blur-md sm:text-sm">
          <Sparkles className="h-3.5 w-3.5" aria-hidden />
          <span>Web UI Cookbook · 2026</span>
        </div>

        <h1
          className="reveal-up text-balance text-center text-4xl font-bold leading-[1.1] tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl"
        ...
        <p
          className="reveal-up mt-6 max-w-2xl text-balance text-center text-base leading-relaxed text-white/85 sm:text-lg md:text-xl"
        ...
        >
          <div className="flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2 text-sm text-white/95 backdrop-blur-md">
            <span className="num text-base font-semibold">37</span>
            <span className="text-white/75">개 슬라이드</span>
          </div>
          <div className="flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2 text-sm text-white/95 backdrop-blur-md">
            <span className="num text-base font-semibold">5</span>
            <span className="text-white/75">개 카테고리</span>
          </div>
          <div className="hidden items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2 text-sm text-white/95 backdrop-blur-md sm:flex">
            <span className="text-white/75">설명 · 코드 · 데모</span>
          </div>
        </div>
