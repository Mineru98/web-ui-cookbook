              ...
              <SheetContent title="목차" side="left" className="w-[300px] sm:w-[400px]">
                <div className="py-4">
                  ...
                  <div className="space-y-1 max-h-[calc(100vh-100px)] overflow-y-auto pr-2">
                    ...
                    {slides.slice(18, 19).map((slide, index) => (
                      <Button
                        key={slide.id}
                    ...
                    {slides.slice(19, 23).map((slide, index) => (
                      <Button
                        key={slide.id}
                        variant={currentSlide === index + 19 ? "default" : "ghost"}
                        className="w-full justify-start"
                        onClick={() => {
                          goToSlide(index + 19)
                        }}
                    ...
                    {slides.slice(23, 36).map((slide, index) => (
                      <Button
                        key={slide.id}
                    ...
                    {slides.slice(36).map((slide, index) => (
                      <Button
                        key={slide.id}
                        variant={currentSlide === index + 36 ? "default" : "ghost"}
                        className="w-full justify-start"
                        onClick={() => {
                          goToSlide(index + 36)
                        }}
